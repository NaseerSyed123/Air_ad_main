...
class B3CartScreen extends StatefulWidget {
  @override
  _B3CartScreenState createState() => _B3CartScreenState();
}

class _B3CartScreenState extends State<B3CartScreen> {
  ...
  void initState() {
    ...
    setState(() {
      ...
      items.add(
        cartItem(
          img: "assets/images/plao.jpg",
          id: 1,
          title: "Student Biryani",
          desc: "Tasty Chicken Biryani",
          price: "\$ 150",
        ),
